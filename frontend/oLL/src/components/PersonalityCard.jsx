...
function PersonalityCard({img ,name, pageChangeHandler}) {
    return ( 
        <div  onClick={()=>pageChangeHandler(name)} className=" bg-black  hover:scale-110  transition-transform duration-300 hover:cursor-pointer w-[20vw] h-[15vh] sm:w-[10vw] sm:h-[22vh] rounded-[20px]  p-[3px]">
            <div  className=" p-0 flex-col flex items-center   w-full h-full rounded-2xl bg-[#0d0d0d]">
              ...
              <div className=' font-medium flex justify-center text-[50%] sm:text-[100%] items-center mt-2 sm:mt-5 text-xl'>
                <h1>{name}</h1>
              </div>
            </div>
        </div>
